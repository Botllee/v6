BURIQ () {
curl -sS https://raw.githubusercontent.com/RidwanzAnphelibelll/v6/main/izin > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/RidwanzAnphelibelll/v6/main/izin | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/RidwanzAnphelibelll/v6/main/izin | awk '{print $4}' | grep $MYIP)
if [ "$MYIP" = "$IZIN" ]; then
Bloman
else
...
Exp=$(curl -sS https://raw.githubusercontent.com/RidwanzAnphelibelll/v6/main/izin | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/RidwanzAnphelibelll/v6/main/versions)
IPVPS=$(curl -s ipinfo.io/ip )
clear
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │                 ${BIWhite}${UWhite}v6-SAPUTRA${NC}"
echo -e "${BICyan} │"
...
echo -e "${BICyan} │  ${BICyan}LOAD CPU   : ${BIYellow}$cpu_usage${NC}"
echo -e "${BICyan} │  ${BICyan}DOMAIN     : ${BIYellow}$(cat /etc/xray/domain)${NC}"
echo -e "${BICyan} │  ${BICyan}SERVER RAM : ${BIYellow}${uram} / ${tram} MB${NC}"
...
echo -e "${BICyan} │  ${BICyan}DATE       : ${BIYellow}$(date +'%A %d %B %Y')${NC}"
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
...
echo -e "${BICyan} │  ${BICyan}[${BIWhite}06${BICyan}] TRIALL  ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"  "${BICyan}  [${BIWhite}13${BICyan}] CHANGE BANNER   ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" "${BICyan} │${NC}"
...
echo -e "        ${BICyan}┌─────────────────────────────────────┐${NC}"
echo -e "        ${BICyan}│$NC Versions    : $(cat /home/ver) Last Updates ${NC}"
...
5) clear ; menu-set ; exit ;;
6) clear ; menu-trial ; exit ;;
7) clear ; menu-backup ; exit ;;
8) clear ; add-host ; exit ;;
9) clear ; running ; exit ;;
10) clear; wget https://raw.githubusercontent.com/RidwanzAnphelibelll/v6/main/udp/udp-custom.sh && chmod +x udp-custom.sh && ./udp-custom.sh ; menu ;;
11) clear ; xolpanel ; menu ;;
12) clear ; bw ; exit ;;
13) clear; nano /etc/issue.net; exit ;;
14) clear ; update ; exit ;;
0) clear ; menu ; exit ;;
x) exit ;;
*) echo -e "" ; echo "Press any key to exit" ; sleep 1 ; exit ;;
esac
